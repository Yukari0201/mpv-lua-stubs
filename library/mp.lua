...
function mp.command_native(table) end
...
function mp.command_native_async(table) end
...
---@param name string
---@return nil
function mp.add_key_binding(key, name_fn, fn, flags) end
function mp.add_key_binding(key, name, fn) end
...
--
---@param name string
---@param type "none"|"native"|"bool"|"string"|"number"|nil
...
--
---@return nil
function mp.dispatch_events() end
